...
* Tenere la app aperta riduce drasticamente il tempo necessario a controllare ogni singolo articolo. Quando la app è chiusa, il processo in background è nettamente più lento consentendole di controllare pochi articoli alla volta.
